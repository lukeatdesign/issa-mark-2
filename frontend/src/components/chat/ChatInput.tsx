  ...
  return (
    <div className="flex items-end gap-3 px-4 py-3 border-t border-gray-100 bg-white">
      ...
      <button
        ...
        className="flex-shrink-0 w-10 h-10 rounded-xl bg-brand-600 text-white flex items-center justify-center hover:bg-brand-700 active:scale-90 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
      >
